...
class GseControllerUndefinedDirectoryException(GseControllerException):
    def __init__(self, val):
        super(GseControllerUndefinedDirectoryException, self).__init__(
            "Path does not exist: %s!" % str(val)
        )


class GseControllerUndefinedFileException(GseControllerException):
    def __init__(self, val):
        super(GseControllerUndefinedFileException, self).__init__(
            "Path does not exist: %s!" % str(val)
        )
...
class GseControllerParsingException(GseControllerException):
    def __init__(self, val):
        super(GseControllerParsingException, self).__init__(
            "Parsing error: %s!" % str(val)
        )
...
class GseControllerStatusUpdateException(GseControllerException):
    def __init__(self, val):
        super(GseControllerStatusUpdateException, self).__init__(
            "Bad status update mode: %s!" % str(val)
        )
