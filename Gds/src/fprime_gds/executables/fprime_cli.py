...
def add_retrieval_arguments(parser: argparse.ArgumentParser, command_name: str):
    """
...
def parse_args(parser: argparse.ArgumentParser, arguments):
    ...
    # TODO: This option is specific to command-send; find some way to move this
    # check to that class?
    if args.func == CommandSendParser.command_func:
