...
class Commands(wx.Panel):
    def __init__(self, parent):
        ...
        self.ImmediateCommandEntries = wx.Panel(
        ...
        self.CmdsComboBox.SetSelection(0)
        ...
        self.CmdArgsScrolledWindow = wx.ScrolledWindow(
            CmdArgsBoxSizer.GetStaticBox(),
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.HSCROLL | wx.SUNKEN_BORDER,
        )
        ...
        CmdArgsBoxSizer.Add(
            self.CmdArgsScrolledWindow, 1, wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 5
        )
        ...
        self.CmdHistListBox = wx.ListBox(
            sbSizer2.GetStaticBox(),
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
            CmdHistListBoxChoices,
            0 | wx.NO_BORDER | wx.TAB_TRAVERSAL,
        )
        ...
        self.CmdHistControlsPanel = wx.Panel(
            self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL
        )
        ...
        self.CmdHistSearchTextCtl = wx.TextCtrl(
            sbSizer3.GetStaticBox(),
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.QuickCmdTextCtl.Bind(
            wx.EVT_TEXT_ENTER, self.onQuickCmdTextCtrlEnterPressed
        )
