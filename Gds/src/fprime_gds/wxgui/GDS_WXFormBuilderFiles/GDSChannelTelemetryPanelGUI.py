...
class ChannelTelemetry(wx.Panel):
    def __init__(self, parent):
        ...
        self.ChannelTelemDataViewCtl = wx.dataview.DataViewCtrl(
            self,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        sbSizer8.Add(
            self.ChannelTelemSelectChannelsButton,
            0,
        ...
        self.ChannelTelemFilterSelectedTextCtl = wx.TextCtrl(
            sbSizer8.GetStaticBox(),
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        sbSizer8.Add(
            self.ChannelTelemFilterSelectedTextCtl,
            3,
            wx.ALIGN_CENTER_VERTICAL | wx.ALL,
            5,
        )
        ...
        sbSizer8.Add(
            self.ChannelTelemShowHexCheckBox, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5
        )
        ...
        # Connect Events
        self.ChannelTelemDataViewCtl.Bind(
            wx.dataview.EVT_DATAVIEW_ITEM_CONTEXT_MENU,
            self.onChannelTelemContextMenu,
            id=wx.ID_ANY,
        )
        self.ChannelTelemSelectChannelsButton.Bind(
            wx.EVT_BUTTON, self.onChannelTelemSelectChannelsButtonClick
        )
        self.ChannelTelemResetFilterButton.Bind(wx.EVT_BUTTON, self.onClickResetFilter)
        self.ChannelTelemShowHexCheckBox.Bind(
            wx.EVT_CHECKBOX, self.onChannelTelemShowHexCheckBoxClick
        )
