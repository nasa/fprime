...
class ChannelFilterDialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.ListBoxAllChannels = wx.ListBox(
            self.m_panel1,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.Size(230, -1),
            ListBoxAllChannelsChoices,
            wx.LB_EXTENDED | wx.LB_HSCROLL | wx.LB_SORT,
        )
        ...
        self.ButtonAddAllChannels.SetFont(
            wx.Font(
                10,
                wx.FONTFAMILY_DEFAULT,
                wx.FONTSTYLE_NORMAL,
        ...
        self.ButtonRemoveAllChannels.SetFont(
            wx.Font(
                10,
                wx.FONTFAMILY_DEFAULT,
                wx.FONTSTYLE_NORMAL,
        ...
        self.ListBoxShowChannels = wx.ListBox(
            self.m_panel1,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.Size(230, -1),
