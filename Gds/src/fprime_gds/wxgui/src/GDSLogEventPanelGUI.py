...
class LogEvents(wx.Panel):
    def __init__(self, parent):
        ...
        self.EventLogDataListCtl = wx.dataview.DataViewCtrl(
            sbSizer61.GetStaticBox(),
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.dataview.DV_MULTIPLE | wx.dataview.DV_VERT_RULES,
        )
        ...
        self.EventLogSeachKeywordTextCtl = wx.TextCtrl(
        ...
        sbSizer7.Add(
            self.EventLogSeachKeywordTextCtl, 3, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5
        )
        ...
        sbSizer7.Add(
            self.EventLogSeverityComboBox, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5
        )
        ...
        sbSizer7.Add(
            self.EventLogApplyFilterButton, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5
        )
        ...
        sbSizer7.Add(
            self.EventLogResetFilterButton, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5
        )
        ...
        # Connect Events
        self.EventLogDataListCtl.Bind(
            wx.dataview.EVT_DATAVIEW_ITEM_CONTEXT_MENU,
            self.onLogEventDataViewContextMenu,
            id=wx.ID_ANY,
        )
        self.EventLogClearButton.Bind(wx.EVT_BUTTON, self.onEventLogClearButtonClick)
        self.EventLogApplyFilterButton.Bind(
            wx.EVT_BUTTON, self.onEventLogApplyFilterButtonClick
        )
        self.EventLogResetFilterButton.Bind(
            wx.EVT_BUTTON, self.onEventLogResetFilterButtonClick
        )
        self.EventLogDataListCtl.Bind(
            wx.EVT_MOUSEWHEEL, self.onEventLogDataListCtrlScroll
        )
