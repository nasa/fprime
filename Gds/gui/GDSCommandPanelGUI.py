...
class Commands ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		CommandsMainBoxSizer.Add( self.CmdHistPanel, 5, wx.EXPAND |wx.ALL, 5 )
		...
		self.QuickCmdTextCtl = wx.TextCtrl( sbSizer4.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
