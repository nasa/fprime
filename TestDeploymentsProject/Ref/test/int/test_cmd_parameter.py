...
def test_send_parameter(fprime_test_api):
    ...
    fprime_test_api.send_and_assert_command(
        "Ref.RecvBuff.PARAMETER1_PRM_SET",
        [1],
        max_delay=5,
    )
    fprime_test_api.send_and_assert_command(
        "Ref.RecvBuff.PARAMETER2_PRM_SET",
        [2],
        max_delay=5,
    )
    fprime_test_api.send_and_assert_command(
    ...
    fprime_test_api.send_and_assert_command(
        "Ref.SendBuff.PARAMETER4_PRM_SET",
        [4],
        max_delay=5,
    )
    ...
    param1_change = fprime_test_api.get_telemetry_pred("Ref.RecvBuff.Parameter1", 10)
    fprime_test_api.assert_telemetry(param1_change, timeout=5)

    # Send PARAMETER1_PRM_SAVE
    fprime_test_api.send_and_assert_command(
        "Ref.RecvBuff.PARAMETER1_PRM_SAVE",
        max_delay=1,
    )
    ...
    param2_change = fprime_test_api.get_telemetry_pred("Ref.RecvBuff.Parameter2", 20)
    fprime_test_api.assert_telemetry(param2_change, timeout=5)

    fprime_test_api.send_and_assert_command(
        "Ref.RecvBuff.PARAMETER2_PRM_SAVE",
        max_delay=5,
    )
    ...
    param3_change = fprime_test_api.get_telemetry_pred("Ref.SendBuff.Parameter3", 30)
    fprime_test_api.assert_telemetry(param3_change, timeout=5)

    fprime_test_api.send_and_assert_command(
        "Ref.SendBuff.PARAMETER3_PRM_SAVE",
        max_delay=5,
    )
    ...
    param4_change = fprime_test_api.get_telemetry_pred("Ref.SendBuff.Parameter4", 40)
    fprime_test_api.assert_telemetry(param4_change, timeout=5)

    fprime_test_api.send_and_assert_command(
        "Ref.SendBuff.PARAMETER4_PRM_SAVE",
        max_delay=5,
    )
