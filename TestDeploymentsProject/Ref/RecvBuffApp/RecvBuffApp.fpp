module Ref {
    ...
    passive component RecvBuff {
        ...
        @ A test parameter
        param parameter1: U32 default 10 id 0 set opcode 0 save opcode 1

        @ A test parameter
        param parameter2: I16 default 11 id 1 set opcode 2 save opcode 3
        ...
        @ Value of Sensor1
        telemetry Sensor1: F32 id 1 format "{.2f}V"
