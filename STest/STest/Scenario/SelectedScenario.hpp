...
class SelectedScenario : public Scenario<State> {
  public:
    // ----------------------------------------------------------------------
    ...
    SelectedScenario(const char* const name,       //!< The name of the scenario
    ...
    SelectedScenario(const SelectedScenario&) = delete;

    //! Deleted copy assignment operator
    SelectedScenario& operator=(const SelectedScenario&) = delete;
  ...
  private:
    ...
    //! \return The rule
    Rule<State>* selectScenario(State& state  //!< The system state
    ) {
        Rule<State>* rule = nullptr;
