...
class RandomlyBoundedScenario : public Scenario<State> {
  public:
    // ----------------------------------------------------------------------
    ...
    RandomlyBoundedScenario(const char* const name,     //!< The name of the bounded scenario
        ...
        : Scenario<State>(name), scenario(scenario), start(start), length(length), boundedScenario(nullptr) {}

    //! Deleted copy constructor
    RandomlyBoundedScenario(const RandomlyBoundedScenario&) = delete;

    //! Deleted copy assignment operator
    RandomlyBoundedScenario& operator=(const RandomlyBoundedScenario&) = delete;
  ...
  private:
    ...
    void reset_Scenario() {
        ...
        this->boundedScenario = new BoundedScenario<State>(this->name, this->scenario, bound);
