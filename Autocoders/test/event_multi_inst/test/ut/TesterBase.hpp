// ======================================================================
// \title  TestLog/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for TestLog component test harness base class
//
// \copyright
...
#ifndef TestLog_TESTER_BASE_HPP
#define TestLog_TESTER_BASE_HPP

#include <Autocoders/test/event_multi_inst/TestComponentAc.hpp>
...
namespace Somewhere {
  ...
  //! \class TestLogTesterBase
  //! \brief Auto-generated base class for TestLog component test harness
  //!
  class TestLogTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object TestLogTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object TestLogTesterBase
      //!
      TestLogTesterBase(
      ...
      //! Destroy object TestLogTesterBase
      //!
      virtual ~TestLogTesterBase(void);
    ...
    protected:
      ...
      //!
      virtual void logIn_DIAGNOSTIC_SomeEvent(
    ...
    protected:
      ...
      //! Handle event AnotherEvent
      //!
      virtual void logIn_ACTIVITY_HI_AnotherEvent(
          U8 arg1, /*!< The U8 command argument*/
          U32 arg2, /*!< The U32 command argument*/
          Fw::LogStringArg& arg3, /*!< The string command argument*/
          TestLogComponentBase::SomeEnum arg4 /*!< The enum command argument*/
      );

      //! A history entry for event AnotherEvent
      //!
      typedef struct {
        U8 arg1;
        U32 arg2;
        Fw::LogStringArg arg3;
        TestLogComponentBase::SomeEnum arg4;
      } EventEntry_AnotherEvent;

      //! The history of AnotherEvent events
      //!
      History<EventEntry_AnotherEvent> 
        *eventHistory_AnotherEvent;
