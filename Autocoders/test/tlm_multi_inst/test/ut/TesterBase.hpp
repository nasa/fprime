// ======================================================================
// \title  TestTlm/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for TestTlm component test harness base class
//
// \copyright
...
#include <Autocoders/test/tlm_multi_inst/TestComponentAc.hpp>
...
namespace Tlm {
  ...
  //! \class TestTlmTesterBase
  //! \brief Auto-generated base class for TestTlm component test harness
  //!
  class TestTlmTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object TestTlmTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object TestTlmTesterBase
      //!
      TestTlmTesterBase(
      ...
      //! Destroy object TestTlmTesterBase
      //!
      virtual ~TestTlmTesterBase(void);
    ...
    protected:
      ...
      //! Handle channel someenumchan
      //!
      virtual void tlmInput_someenumchan(
          const Fw::Time& timeTag, /*!< The time*/
          const TestTlmComponentBase::SomeEnum& val /*!< The channel value*/
      );

      //! A telemetry entry for channel someenumchan
      //!
      typedef struct {
        Fw::Time timeTag;
        TestTlmComponentBase::SomeEnum arg;
      } TlmEntry_someenumchan;
