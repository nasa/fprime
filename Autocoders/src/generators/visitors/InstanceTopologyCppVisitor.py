...
#
from generators.templates.topology import includes1TopologyCpp
from generators.templates.topology import publicInstanceTopologyCpp
...
class InstanceTopologyCppVisitor(AbstractVisitor.AbstractVisitor):
    ...
    def publicVisit(self, obj):
        ...
        for id_tuple in obj.get_base_id_list():
            ...
            if(obj.is_ptr):
                declaration_template = """{}_ptr->setIdBase({});""".format(n , hex(base_id))
            else:
