...
#include <Autocoders/test/param_enum/TestComponentAc.hpp>
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      void paramSet_enumparam(
          const TestPrmComponentBase::SomeEnum& val, /*!< The parameter value*/
    ...
    private:
      ...
      //! Parameter enumparam
      //!
      TestPrmComponentBase::SomeEnum m_param_enumparam;
