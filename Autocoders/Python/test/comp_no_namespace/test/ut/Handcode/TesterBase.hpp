    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      void invoke_to_aport(
          ...
          Quaternion arg5, /*!< The second argument*/
    ...
    protected:
      ...
      virtual void logIn_ACTIVITY_LO_SomeEvent(
          Quaternion arg1, /*!< The quaternion command argument*/
    ...
    protected:
      ...
      void paramSet_someparam(
          const Quaternion& val, /*!< The parameter value*/
