// ======================================================================
// \title  ExampleComponent/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for ExampleComponent component test harness base class
//
// \copyright
...
namespace ExampleComponents {
  ...
  //! \class ExampleComponentTesterBase
  //! \brief Auto-generated base class for ExampleComponent component test harness
  //!
  class ExampleComponentTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object ExampleComponentTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object ExampleComponentTesterBase
      //!
      ...
      //! Destroy object ExampleComponentTesterBase
      //!
      virtual ~ExampleComponentTesterBase(void);
