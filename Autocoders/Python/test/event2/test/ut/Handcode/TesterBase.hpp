...
#include <Autocoders/Python/test/event2/TestComponentAc.hpp>
...
namespace Cmd {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      //!
      virtual void logIn_WARNING_HI_SomeEvent(
          I32 arg1, /*!< The I32 command argument*/
          F32 arg2, /*!< The F32 command argument*/
          Ref::Gnc::Quaternion arg3 /*!< The U8 command argument*/
      );
