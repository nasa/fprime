...
namespace Cmd {
  ...
  void Test1TesterBase ::
    sendCmd_TEST_CMD_1(
        ...
        F32 arg2,
        U8 arg3,
        Test1ComponentBase::SomeEnum arg4
    )
  {
    ...
    FW_ASSERT(_status == Fw::FW_SERIALIZE_OK,static_cast<AssertArg>(_status));
    _status = buff.serialize((FwEnumStoreType) arg4);
    FW_ASSERT(_status == Fw::FW_SERIALIZE_OK,static_cast<AssertArg>(_status));
    ...
    switch (instance) {
       case 0:
          _opcode = Test1ComponentBase::OPCODE_TEST_CMD_1_0 + idBase;
          break;
       case 1:
          _opcode = Test1ComponentBase::OPCODE_TEST_CMD_1_1 + idBase;
          break;
       default:
    ...
    )
  {
    ...
    switch (instance) {
       case 0:
          _opcode = Test1ComponentBase::OPCODE_TEST_CMD_2_0 + idBase;
          break;
       case 1:
          _opcode = Test1ComponentBase::OPCODE_TEST_CMD_2_1 + idBase;
          break;
       default:
          FW_ASSERT(0,instance);
          break;
