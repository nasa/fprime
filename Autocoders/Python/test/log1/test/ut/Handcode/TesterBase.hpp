// ======================================================================
// \title  TestEvent/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for TestEvent component test harness base class
//
// \copyright
...
namespace Tlm {
  ...
  //! \class TestEventTesterBase
  //! \brief Auto-generated base class for TestEvent component test harness
  //!
  class TestEventTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object TestEventTesterBase
      //!
      virtual void init(
    ...
    public:
      ...
      void connect_to_aport(
          ...
          Another::InputTest4Port *const aport //!< The port
      );
    ...
    protected:
      ...
      //! Construct object TestEventTesterBase
      //!
      TestEventTesterBase(
      ...
      //! Destroy object TestEventTesterBase
      //!
      virtual ~TestEventTesterBase(void);
    ...
    private:
      ...
      //!
      Another::OutputTest4Port m_to_aport[1];
    ...
    private:
      ...
      //!
      static Fw::Time from_Time_static(
