...
namespace Somewhere {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      //!
      virtual void logIn_DIAGNOSTIC_SomeOtherEvent(
          I32 arg1, /*!< The I32 command argument*/
          F32 arg2, /*!< The F32 command argument*/
          U8 arg3 /*!< The U8 command argument*/
      );

      //! A history entry for event SomeOtherEvent
      //!
      typedef struct {
        I32 arg1;
        F32 arg2;
        U8 arg3;
      } EventEntry_SomeOtherEvent;

      //! The history of SomeOtherEvent events
      //!
      History<EventEntry_SomeOtherEvent>
        *eventHistory_SomeOtherEvent;
