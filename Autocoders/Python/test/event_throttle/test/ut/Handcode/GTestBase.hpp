...
#define ASSERT_EVENTS_SomeOtherEvent_SIZE(size) \
  this->assertEvents_SomeOtherEvent_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_SomeOtherEvent(index, _arg1, _arg2, _arg3) \
  this->assertEvents_SomeOtherEvent(__FILE__, __LINE__, index, _arg1, _arg2, _arg3)
...
namespace Somewhere {
    ...
    public TestLogTesterBase
  {
    ...
    protected:
      ...
      void assertEvents_SomeOtherEvent_size(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 size /*!< The asserted size*/
      ) const;
