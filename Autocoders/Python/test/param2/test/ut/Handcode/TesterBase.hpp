...
#include <Autocoders/Python/test/param2/TestComponentAc.hpp>
...
namespace Tlm {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      void paramSend_AQuat(
          const NATIVE_INT_TYPE instance, /*!< The instance number*/
          const U32 cmdSeq /*!< The command sequence number*/
      );

      void paramSave_AQuat(
          const NATIVE_INT_TYPE instance, /*!< The instance number*/
          const U32 cmdSeq /*!< The command sequence number*/
      );
    ...
    private:
      ...
      //! True if parameter AQuat was successfully received
      //!
      Fw::ParamValid m_param_AQuat_valid;
    ...
    private:
      ...
      //! Parameter AQuat
      //!
      Ref::Gnc::Quaternion m_param_AQuat;
