...
namespace Somewhere {
...
#endif
  {
    ...
    this->eventHistory_AnotherEvent =
      new History<EventEntry_AnotherEvent>(maxHistorySize);
    // Clear history
    this->clearHistory();
  }
    ...
    ~TestLogTesterBase(void)
  {
    ...
    delete this->eventHistory_AnotherEvent;
  }
    ...
    )
  {
    ...
    switch (id - idBase) {
      ...
      case TestLogComponentBase::EVENTID_ANOTHEREVENT_1:
      {
        ...
        FwEnumStoreType arg4Int;
        _status = args.deserialize(arg4Int);
        TestLogComponentBase::SomeEnum arg4 = static_cast<TestLogComponentBase::SomeEnum>(arg4Int);
        FW_ASSERT(
            _status == Fw::FW_SERIALIZE_OK,
            static_cast<AssertArg>(_status)
        );

        this->logIn_ACTIVITY_HI_AnotherEvent(arg1, arg2, arg3, arg4);
    ...
    clearEvents(void)
  {
    ...
    this->eventHistory_AnotherEvent->clear();
  }
  ...
  void TestLogTesterBase ::
    logIn_ACTIVITY_HI_AnotherEvent(
        U8 arg1,
        U32 arg2,
        Fw::LogStringArg& arg3,
  ...
  {
    EventEntry_AnotherEvent e = {
      arg1, arg2, arg3, arg4
    };
    eventHistory_AnotherEvent->push_back(e);
    ++this->eventsSize;
  }
