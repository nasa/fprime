...
#define ASSERT_TLM_someenumchan_SIZE(size) \
  this->assertTlm_someenumchan_size(__FILE__, __LINE__, size)

#define ASSERT_TLM_someenumchan(index, value) \
  this->assertTlm_someenumchan(__FILE__, __LINE__, index, value)
...
namespace Tlm {
    ...
    public TestTlmTesterBase
  {
    ...
    protected:
      ...
      //! Assert telemetry value in history at index
      //!
      void assertTlm_someenumchan_size(
          const char *const __ISF_callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __ISF_callSiteLineNumber, /*!< The line number of the call site*/
          const U32 size /*!< The asserted size*/
      ) const;

      void assertTlm_someenumchan(
          const char *const __ISF_callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __ISF_callSiteLineNumber, /*!< The line number of the call site*/
          const U32 index, /*!< The index*/
