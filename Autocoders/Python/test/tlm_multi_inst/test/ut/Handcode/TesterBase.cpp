...
namespace Tlm {
    ...
    ~TestTlmTesterBase(void)
  {
    ...
    delete this->tlmHistory_someenumchan;
  }
    ...
    )
  {
    ...
    switch (id - idBase) {
      ...
      case TestTlmComponentBase::CHANNELID_SOMECHAN_0:
      case TestTlmComponentBase::CHANNELID_SOMECHAN_1:
      {
        U32 arg;
      ...
      case TestTlmComponentBase::CHANNELID_ANOTHERCHAN_0:
      case TestTlmComponentBase::CHANNELID_ANOTHERCHAN_1:
      {
        U8 arg;
        const Fw::SerializeStatus _status = val.deserialize(arg);
        if (_status != Fw::FW_SERIALIZE_OK) {
      ...
      case TestTlmComponentBase::CHANNELID_SOMEENUMCHAN_0:
      case TestTlmComponentBase::CHANNELID_SOMEENUMCHAN_1:
      {
        FwEnumStoreType someenumchanarg;
        const Fw::SerializeStatus _status = val.deserialize(someenumchanarg);
        if (_status != Fw::FW_SERIALIZE_OK) {
  ...
  {
    TlmEntry_someenumchan e = { timeTag, val };
    this->tlmHistory_someenumchan->push_back(e);
    ++this->tlmSize;
  }
