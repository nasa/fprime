...
namespace Prm {
    ...
    )
  {
    ...
    switch (instance) {
      case 0:
         _prmOpcode =  TestPrmComponentBase::OPCODE_SOMEPARAM_0_SET + idBase;
         break;
      case 1:
         _prmOpcode =  TestPrmComponentBase::OPCODE_SOMEPARAM_1_SET + idBase;
         break;
      default:
...

  {
    ...
    const U32 idBase = this->getIdBase();
     switch (instance) {
        case 0:
          _prmOpcode = TestPrmComponentBase::OPCODE_SOMEPARAM_0_SAVE + idBase;
          break;
        case 1:
          _prmOpcode = TestPrmComponentBase::OPCODE_SOMEPARAM_1_SAVE + idBase;
          break;
        default:
          FW_ASSERT(0,instance);
          break;
