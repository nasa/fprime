...
class ConfigManager(parent):
    ...
    def _setProps(self):
        ...
        self.__prop['special_ports']['CmdResponse']['port_file'] = 'Fw/Cmd/CmdResponsePortAi.xml'
        ...
        self.__prop['special_ports']['CmdRegistration']['port_file'] = 'Fw/Cmd/CmdRegPortAi.xml'
        ...
        self.__prop['special_ports']['LogTextEvent']['port_file'] = 'Fw/Log/LogTextPortAi.xml'
        ...
        self.__prop['special_ports']['ParamGet']['port_file'] = 'Fw/Prm/PrmGetPortAi.xml'
