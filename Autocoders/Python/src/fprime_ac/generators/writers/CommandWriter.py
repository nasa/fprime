...
# the command Python dictionary for the GDS.
#
# AUTHOR: Jordan Ishii
...
class CommandWriter(AbstractDictWriter.AbstractDictWriter):
    """
    ...
    def __init__(self):
        ...
        DEBUG.info("CommandWriter: Instanced.")
        self.bodytext       = ""
        self.prototypetext  = ""
    ...
    def _writeTmpl(self, c, fp, write_str):
        ...
        """
        DEBUG.debug('CommandWriter:%s' % write_str)
        DEBUG.debug('===================================')
        DEBUG.debug(c)
    ...
    def DictHeaderWrite(self, obj):
        ...
        if type(obj) is Command.Command:
            ...
            for opcode in obj.get_opcodes():
                ...
                self._writeTmpl(c, self.__fp1[inst], "commandHeaderWrite")
                inst += 1
            ...
            for opcode in obj.get_save_opcodes():
                ...
                c.user = os.environ['USER']
                c.source = obj.get_xml_filename()
                self._writeTmpl(c, self.__fp2[inst], "commandHeaderWrite")
                inst += 1
    ...
    def DictBodyWrite(self, obj):
        ...
        if type(obj) is Command.Command:
            ...
            for opcode in obj.get_opcodes():
                ...
                self._writeTmpl(c, self.__fp1[inst], "commandBodyWrite")
        ...
        if type(obj) is Parameter.Parameter:
            ...
            for opcode in obj.get_save_opcodes():
                ...
                self._writeTmpl(c, self.__fp2[inst], "commandBodyWrite")
