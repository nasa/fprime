...
# NAME: Private
#
# DESCRIPTION:  The Private class is the main entry point
#                 for generation of private code within a class.
#
# USAGE: Nominally the Private.__call__ is called by using the
