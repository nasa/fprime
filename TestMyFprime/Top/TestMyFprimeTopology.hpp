// ======================================================================
// \title  TestMyFprimeTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TESTMYFPRIME_TESTMYFPRIMETOPOLOGY_HPP
#define TESTMYFPRIME_TESTMYFPRIMETOPOLOGY_HPP
// Included for access to TestMyFprime::TopologyState and TestMyFprime::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <TestMyFprime/Top/TestMyFprimeTopologyDefs.hpp>

// Remove unnecessary TestMyFprime:: qualifications
using namespace TestMyFprime;
namespace TestMyFprime {
/**
 ...
 * TestMyFprime::TopologyState see: TestMyFprimeTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type TestMyFprime::TopologyState see: TestMyFprimeTopologyDefs.hpp.
 *
