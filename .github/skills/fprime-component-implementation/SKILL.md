...
description: >-
  ...
  CPP-36). Trigger when the FPP model is confirmed and the next step
...
(`fprime-cpp-design`, CPP-1 through CPP-36) are mandatory.
...
`fprime-cpp-design` (CPP-1 through CPP-36).
