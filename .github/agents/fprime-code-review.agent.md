...
single source of truth for the rule set (CPP-1 through CPP-36) and
...
construct violates one of the rules CPP-1 through CPP-36 in
...
4. **`+` lines for F Prime type idioms (CPP-3, CPP-21, CPP-22,
   CPP-23, CPP-24, CPP-28, CPP-35, CPP-36)**. Scan signatures and member
   ...
   argument set (CPP-36). Particularly check public APIs and
