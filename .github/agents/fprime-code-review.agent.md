...
single source of truth for the rule set (CPP-1 through CPP-35) and
...
construct violates one of the rules CPP-1 through CPP-35 in
...
4. **`+` lines for F Prime type idioms (CPP-3, CPP-21, CPP-22,
   CPP-23, CPP-24, CPP-28, CPP-35)**. Scan signatures and member
   ...
   where an FPP enum belongs (CPP-35). Particularly check public
   APIs and ground-facing interfaces (CPP-23).
