...
SmTest::SmTest(const char* const compName) : SmTestComponentBase(compName) {}
...
void SmTest::DeviceSm_a1(const FwEnumStoreType stateMachineId,
...
bool SmTest::DeviceSm_g2(const FwEnumStoreType stateMachineId,
                         const DeviceSm_Signals signal,
                         const Fw::SmSignalBuffer& data) {
    return true;
}
