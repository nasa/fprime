...
#include "FppTest/component/common/tester.hpp"
  ...
  private:
    ...
    U8 primitiveData[PrimitiveArgsPortBuffer::SERIALIZED_SIZE];
    U8 stringData[StringArgsPortBuffer::SERIALIZED_SIZE];
    U8 enumData[EnumArgsPortBuffer::SERIALIZED_SIZE];
    U8 arrayData[ArrayArgsPortBuffer::SERIALIZED_SIZE];
    U8 structData[StructArgsPortBuffer::SERIALIZED_SIZE];
