...
then
    echo "${BLUE}Cleaning Repository at ${FPRIME_DIR:-.}${NOCOLOR}"
    git clone -xdffe "ci-*" "${FPRIME_DIR:-.}" 1>/dev/null 2>/dev/null || fail_and_stop "Failed to clean git repository before testing"
fi
