...
then
    echo -e "${BLACK}Cleaning Repository at ${FPRIME_DIR:-.}${BLACK}"
    git clean -xdffe "ci-*" "${FPRIME_DIR:-.}" 1>/dev/null 2>/dev/null || fail_and_stop "Successfully clean git repository before testing"
fi
