...
def test_send_fileDownlink_command(fprime_test_api):
    ...
    ## source = /tmp/ref_test_seq_wait.bin   ,   Dest = /tmp/chuynh/fprime-downlink/DL.log
    ...
    ## source = /tmp/1MiB.txt   ,   Dest = /tmp/chuynh/fprime-downlink/DL3.log, start offset 0 , for 100 Bytes
