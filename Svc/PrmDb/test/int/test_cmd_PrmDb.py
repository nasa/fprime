...
def test_send_PrmDb(fprime_test_api):
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.getCmdDispName('Ref.SendBuff') + '.' + 'PARAMETER4_PRM_SET', [8], max_delay=5)
    
    # send command PARAMETER1_PRM_SET / SAVE
    fprime_test_api.send_and_assert_command(fprime_test_api.getCmdDispName('Ref.RecvBuff') + '.' + 'PARAMETER1_PRM_SET', [11], max_delay=5)
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.getCmdDispName('Ref.SendBuff') + '.' + 'PARAMETER3_PRM_SET', [33], max_delay=5)
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.getCmdDispName('Ref.SendBuff') + '.' + 'PARAMETER4_PRM_SET', [44], max_delay=5)
