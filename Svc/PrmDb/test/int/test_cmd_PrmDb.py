...
def test_send_PrmDb(fprime_test_api):
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.FileManager') + '.' + 'MoveFile', ["PrmDb.dat",fprime_test_api.get_mnemonic('Svc.PrmDb.filename')], max_delay=1)
