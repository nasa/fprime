...
def test_seqgen(fprime_test_api):
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CmdSequencer') + '.' + 'CS_AUTO', max_delay=10)
    ...
    fprime_test_api.uplink_file_and_await_completion("ref_test_seq.bin", "/tmp/ref_test_seq.bin", timeout=100)
    fprime_test_api.uplink_file_and_await_completion("ref_test_seq_wait.bin", "/tmp/ref_test_seq_wait.bin", timeout=100)
...
def test_send_seq(fprime_test_api):
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CmdSequencer') + '.' + 'CS_VALIDATE',["/tmp/ref_test_seq.bin"], max_delay=10)    
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CommandDispatcher') + '.' + 'CMD_NO_OP_STRING',["test_string_execute_2 auto completed"], max_delay=10)    
    
    ######    ######    ######
    ## Toggle Manual/AUTO
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CmdSequencer') + '.' + 'CS_MANUAL', max_delay=10)
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CmdSequencer') + '.' + 'CS_AUTO', max_delay=10)
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CmdSequencer') + '.' + 'CS_CANCEL', max_delay=10)        

    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CommandDispatcher') + '.' + 'CMD_NO_OP_STRING',["manually START/CANCEL after cmd 0"], max_delay=10)
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CmdSequencer') + '.' + 'CS_START', max_delay=10)
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CommandDispatcher') + '.' + 'CMD_NO_OP_STRING',["manually START command 0"], max_delay=10)
    ...
    time.sleep(10)    
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CmdSequencer') + '.' + 'CS_STEP', max_delay=10)
    time.sleep(130)    
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.CmdSequencer') + '.' + 'CS_STEP', max_delay=3)    
    
    # cleanup sequence files (sequence create local and uplink files)
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.FileManager') + '.' + 'RemoveFile', ["/tmp/ref_test_seq.bin", True] , max_delay=15)
    fprime_test_api.send_and_assert_command(fprime_test_api.get_mnemonic('Svc.FileManager') + '.' + 'RemoveFile', ["/tmp/ref_test_seq_wait.bin", True] , max_delay=15)   
    ######    ######    ######              
