...
module Svc {
  ...
  passive component CmdSplitter {
    ...
    sync input port CmdBuff: [CmdSplitterPorts] Fw.ComBufferSend
    ...
    output port LocalCmd: [CmdSplitterPorts] Fw.ComBufferSend

    @ Output port for remote commands
    output port RemoteCmd: [CmdSplitterPorts] Fw.ComBufferSend
