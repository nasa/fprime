...
namespace Svc {
  ...
  // ----------------------------------------------------------------------
    ...
    void VersionTester :: clear_all() {
        ...
        this->clearHistory();
        ASSERT_EVENTS_FRAMEWORK_VERSION_SIZE(0);
        ASSERT_EVENTS_PROJECT_VERSION_SIZE(0);
        ASSERT_EVENTS_LIBRARY_VERSIONS_SIZE(0);
        ASSERT_EVENTS_CUSTOM_VERSIONS_SIZE(0);
        ASSERT_TLM_FRAMEWORK_VERSION_SIZE(0);
        ASSERT_TLM_PROJECT_VERSION_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_01_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_02_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_03_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_04_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_05_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_06_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_07_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_08_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_09_SIZE(0);
        ASSERT_TLM_LIBRARY_VERSION_10_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_01_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_02_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_03_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_04_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_05_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_06_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_07_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_08_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_09_SIZE(0);
        ASSERT_TLM_CUSTOM_VERSION_10_SIZE(0);
    }
    // ----------------------------------------------------------------------
    // Test STARTUP
    // ----------------------------------------------------------------------
    void VersionTester :: test_startup() {
        ...
        //TODO: Need to figure out how to put in artifical sets to test them
        ASSERT_EVENTS_LIBRARY_VERSIONS_SIZE(12);
        ASSERT_EVENTS_LIBRARY_VERSIONS(0, "blah0 @ blah0");
    }
    ...
    test_enable()
  {
    ...
    ASSERT_EVENTS_CUSTOM_VERSIONS_SIZE(10);
    ...
    test_versions()
  {
    ...
    ASSERT_TLM_FRAMEWORK_VERSION_SIZE(1);
    ASSERT_TLM_FRAMEWORK_VERSION(0, Project::Version::FRAMEWORK_VERSION);
    ASSERT_EVENTS_FRAMEWORK_VERSION_SIZE(1);
    ASSERT_EVENTS_FRAMEWORK_VERSION(0, Project::Version::FRAMEWORK_VERSION);
    ...
    ASSERT_CMD_RESPONSE (0, 1, 9, Fw::CmdResponse::OK);
    ASSERT_TLM_PROJECT_VERSION_SIZE(1);
    ASSERT_TLM_PROJECT_VERSION(0, Project::Version::FRAMEWORK_VERSION);
    ASSERT_EVENTS_PROJECT_VERSION_SIZE(1);
    ASSERT_EVENTS_PROJECT_VERSION(0, Project::Version::FRAMEWORK_VERSION);
    ...
    ASSERT_TLM_LIBRARY_VERSION_01_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_01(0, "blah0 @ blah0");
    ASSERT_EVENTS_LIBRARY_VERSIONS(0, "blah0 @ blah0");

    ASSERT_TLM_LIBRARY_VERSION_02_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_02(0, "blah1 @ blah1");
    ASSERT_EVENTS_LIBRARY_VERSIONS(1, "blah1 @ blah1");

    ASSERT_TLM_LIBRARY_VERSION_03_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_03(0, "blah2 @ blah2");
    ASSERT_EVENTS_LIBRARY_VERSIONS(2, "blah2 @ blah2");

    ASSERT_TLM_LIBRARY_VERSION_04_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_04(0, "blah3 @ blah3");
    ASSERT_EVENTS_LIBRARY_VERSIONS(3, "blah3 @ blah3");

    ASSERT_TLM_LIBRARY_VERSION_05_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_05(0, "blah4 @ blah4");
    ASSERT_EVENTS_LIBRARY_VERSIONS(4, "blah4 @ blah4");

    ASSERT_TLM_LIBRARY_VERSION_06_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_06(0, "blah5 @ blah5");
    ASSERT_EVENTS_LIBRARY_VERSIONS(5, "blah5 @ blah5");

    ASSERT_TLM_LIBRARY_VERSION_07_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_07(0, "blah6 @ blah6");
    ASSERT_EVENTS_LIBRARY_VERSIONS(6, "blah6 @ blah6");

    ASSERT_TLM_LIBRARY_VERSION_08_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_08(0, "blah7 @ blah7");
    ASSERT_EVENTS_LIBRARY_VERSIONS(7, "blah7 @ blah7");

    ASSERT_TLM_LIBRARY_VERSION_09_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_09(0, "blah8 @ blah8");
    ASSERT_EVENTS_LIBRARY_VERSIONS(8, "blah8 @ blah8");

    ASSERT_TLM_LIBRARY_VERSION_10_SIZE(1);
    ASSERT_TLM_LIBRARY_VERSION_10(0, "blah9 @ blah9");
    ASSERT_EVENTS_LIBRARY_VERSIONS(9, "blah9 @ blah9");

    ASSERT_EVENTS_LIBRARY_VERSIONS(10, "blah10 @ blah10");

    ASSERT_EVENTS_LIBRARY_VERSIONS(11, "blah11 @ blah11");


    this->clear_all();
    Svc::CusVerDb cus_data_struct;
    ...
    ASSERT_EVENTS_CUSTOM_VERSIONS(2,Svc::VersionCfg::VersionEnum::PROJECT_VERSION_02,"ver_2");
    cus_data_struct.set(Svc::VersionCfg::VersionEnum::PROJECT_VERSION_02, "ver_2", Svc::VersionStatus::OK);
    ASSERT_TLM_CUSTOM_VERSION_03(0, cus_data_struct);
    ASSERT_TLM_CUSTOM_VERSION_03_SIZE(1);
    
    ASSERT_EVENTS_CUSTOM_VERSIONS(3,Svc::VersionCfg::VersionEnum::PROJECT_VERSION_03,"ver_3");
    cus_data_struct.set(Svc::VersionCfg::VersionEnum::PROJECT_VERSION_03, "ver_3", Svc::VersionStatus::FAILURE);
    ASSERT_TLM_CUSTOM_VERSION_04(0, cus_data_struct);
    ASSERT_TLM_CUSTOM_VERSION_04_SIZE(1);
    
    ASSERT_EVENTS_CUSTOM_VERSIONS(6,Svc::VersionCfg::VersionEnum::PROJECT_VERSION_06,"ver_6");
    cus_data_struct.set(Svc::VersionCfg::VersionEnum::PROJECT_VERSION_06, "ver_6", Svc::VersionStatus::FAILURE);
    ASSERT_TLM_CUSTOM_VERSION_07(0, cus_data_struct);
    ASSERT_TLM_CUSTOM_VERSION_07_SIZE(1);
    ...
    ASSERT_TLM_CUSTOM_VERSION_10(0, cus_data_struct);
    ASSERT_TLM_CUSTOM_VERSION_10_SIZE(1);
  ...
  void VersionTester :: test_setVer(bool is_enabled) {
    ...
    Svc::VersPortStrings::StringSize80 set_ver = "ver_2";
    ...
    if(is_enabled == true) {
        ASSERT_EVENTS_CUSTOM_VERSIONS_SIZE(1);
        ASSERT_EVENTS_CUSTOM_VERSIONS(0,Svc::VersionCfg::VersionEnum::PROJECT_VERSION_00,"ver_0");
        cus_data_struct.set(Svc::VersionCfg::VersionEnum::PROJECT_VERSION_00, set_ver, Svc::VersionStatus::OK);
        ASSERT_TLM_CUSTOM_VERSION_01(0, cus_data_struct);
    }

    set_ver = "ver_1";
    this->invoke_to_setVersion(0, Svc::VersionCfg::VersionEnum::PROJECT_VERSION_01, set_ver, status);
    if(is_enabled == true) {
        ASSERT_EVENTS_CUSTOM_VERSIONS_SIZE(2);
        ASSERT_EVENTS_CUSTOM_VERSIONS(1,Svc::VersionCfg::VersionEnum::PROJECT_VERSION_01,"ver_1");
        cus_data_struct.set(Svc::VersionCfg::VersionEnum::PROJECT_VERSION_01, set_ver, Svc::VersionStatus::OK);
        ASSERT_TLM_CUSTOM_VERSION_02(0, cus_data_struct);
    }

    set_ver = "ver_2";
    this->invoke_to_setVersion(0, Svc::VersionCfg::VersionEnum::PROJECT_VERSION_02, set_ver, status);
    if(is_enabled == true) {
        ASSERT_EVENTS_CUSTOM_VERSIONS_SIZE(3);
        ASSERT_EVENTS_CUSTOM_VERSIONS(2,Svc::VersionCfg::VersionEnum::PROJECT_VERSION_02,"ver_2");
    ...
    if(is_enabled == true) {
        ASSERT_EVENTS_CUSTOM_VERSIONS_SIZE(4);
        ASSERT_EVENTS_CUSTOM_VERSIONS(3,Svc::VersionCfg::VersionEnum::PROJECT_VERSION_03,"ver_3");
    ...
    if(is_enabled == true) {
        ASSERT_EVENTS_CUSTOM_VERSIONS_SIZE(8);
        ASSERT_EVENTS_CUSTOM_VERSIONS(7,Svc::VersionCfg::VersionEnum::PROJECT_VERSION_07,"ver_7");
        cus_data_struct.set(Svc::VersionCfg::VersionEnum::PROJECT_VERSION_07, set_ver, Svc::VersionStatus::OK);
        ASSERT_TLM_CUSTOM_VERSION_08(0, cus_data_struct);
    }

    set_ver = "ver_8";
    this->invoke_to_setVersion(0, Svc::VersionCfg::VersionEnum::PROJECT_VERSION_08, set_ver, status);
    if(is_enabled == true) {
        ASSERT_EVENTS_CUSTOM_VERSIONS_SIZE(9);
        ASSERT_EVENTS_CUSTOM_VERSIONS(8,Svc::VersionCfg::VersionEnum::PROJECT_VERSION_08,"ver_8");
        cus_data_struct.set(Svc::VersionCfg::VersionEnum::PROJECT_VERSION_08, set_ver, Svc::VersionStatus::OK);
        ASSERT_TLM_CUSTOM_VERSION_09(0, cus_data_struct);
    }
