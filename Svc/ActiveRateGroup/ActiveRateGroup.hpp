...
namespace Svc {
    ...
    class ActiveRateGroup : public ActiveRateGroupComponentBase {
        public:
            static constexpr NATIVE_INT_TYPE CHILD_COUNT_MAX = NUM_RATEGROUPMEMBEROUT_OUTPUT_PORTS;
        ...
        PRIVATE:
            ...
            NATIVE_INT_TYPE m_contexts[CHILD_COUNT_MAX]; //!< Must match number of output ports
