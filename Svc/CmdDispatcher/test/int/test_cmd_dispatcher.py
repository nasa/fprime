...
def test_send_command(fprime_test_api):
    ...
    fprime_test_api.send_and_assert_command("cmdDisp.CMD_CLEAR_TRACKING", max_delay=0.1)

    fprime_test_api.send_and_assert_command("cmdDisp.CMD_NO_OP_STRING",["test_string_2"], max_delay=0.1)
    
    fprime_test_api.send_and_assert_command("cmdDisp.CMD_TEST_CMD_1",[2,3,4], max_delay=0.1)
