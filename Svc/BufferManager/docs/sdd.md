...
**For a detailed guide on how to use the BufferManager component, please refer to the [Dynamic Memory Management User Manual](../../../docs/user-manual/framework/dynamic-memory.md).**
