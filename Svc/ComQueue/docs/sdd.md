...
| SVC-COMQUEUE-009 | SVC::COMQUEUE shall process `Fw:Buffer` and `Fw:ComBuffer` messages on the queue based on priority levels                                                                        | Allows flexibility on how the data should be collected ahd prioritized                                                                                     | Unit Test           | 
