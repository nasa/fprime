...
module Ccsds {
    ...
    @ Port for requesting the SDLS key bound to a security association: the provided
    @ buffer is filled with the key for that SA
    port SdlsKey (securityAssociationIndex: U16, ref key: SdlsKeyBuffer) -> SdlsStatus
