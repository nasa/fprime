...
void AosDeframerTester::testInvalidLengthToken() {
    U8 dataLength = static_cast<U8>(STest::Random::lowerUpper(1, 200));  // bytes of data, random length
    U8 data[dataLength];
...
void AosDeframerTester::setComponentState(U16 scid, U8 vcid, U8 sequenceNumber, bool acceptAllVcid) {
    this->component.configure(vcid, scid, acceptAllVcid);
}

Fw::Buffer AosDeframerTester::assembleFrameBuffer(U8* data, U8 dataLength, U16 scid, U8 vcid, U8 seqNumber) {
