...
class AosDeframer : public AosDeframerComponentBase {
  ...
  public:
    ...
    //! \brief Configure the AosDeframer to deframe only a specific VCID and spacecraft ID
    //!
    //! By default, the AosDeframer is configured with the spacecraft ID set in the config/ComCfg.fpp file,
    //! and deframes all incoming frames regardless of their VCID. Should project instantiate a AosDeframer
