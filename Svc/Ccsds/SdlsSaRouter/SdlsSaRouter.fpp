module Svc {
  module Ccsds {
    ...
    passive component SdlsSaRouter {
      ...
      event TrackingTableFull() \
        severity warning high \
        format "SA router tracking table full: data dropped and buffer returned"

      @ A returned buffer was not found in the tracking table; it was returned upstream
      event UntrackedBufferReturned() \
        severity warning high \
        format "SA router received an untracked buffer return"
    }
  }
}
