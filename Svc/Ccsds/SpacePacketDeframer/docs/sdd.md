...
| Packet Type | `pktType` | Extracted from bit [12] of the Packet Identification field (0=Telemetry, 1=Command). Propagated only; routing is by APID and the type bit is not validated against it. |
