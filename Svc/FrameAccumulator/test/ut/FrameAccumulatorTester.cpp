...
void FrameAccumulatorTester ::testFrameDetected() {
    ...
    this->invoke_to_dataIn(0, buffer, Drv::ByteStreamStatus::OP_OK);
    // Checks
...
void FrameAccumulatorTester ::testAccumulateTwoBuffers() {
    ...
    // Receive the buffer on dataIn
    this->invoke_to_dataIn(0, buffer1, Drv::ByteStreamStatus::OP_OK);
    ...
    // Receive the buffer on dataIn
    this->invoke_to_dataIn(0, buffer2, Drv::ByteStreamStatus::OP_OK);
