...
class FpySequencerTester : public FpySequencerGTestBase, public ::testing::Test {
  ...
  protected:
    ...
    void add_BINARY_REG_OP(FpySequencer_StackOpDirective dir);
    ...
    I64 tester_op_or(I64 lhs, I64 rhs);
    I64 tester_op_and(I64 lhs, I64 rhs);
    I64 tester_op_ieq(I64 lhs, I64 rhs);
    I64 tester_op_ine(I64 lhs, I64 rhs);
    I64 tester_op_ult(I64 lhs, I64 rhs);
    I64 tester_op_ule(I64 lhs, I64 rhs);
    I64 tester_op_ugt(I64 lhs, I64 rhs);
    I64 tester_op_uge(I64 lhs, I64 rhs);
    I64 tester_op_slt(I64 lhs, I64 rhs);
    I64 tester_op_sle(I64 lhs, I64 rhs);
    I64 tester_op_sgt(I64 lhs, I64 rhs);
    I64 tester_op_sge(I64 lhs, I64 rhs);
    I64 tester_op_feq(I64 lhs, I64 rhs);
    I64 tester_op_fne(I64 lhs, I64 rhs);
    I64 tester_op_flt(I64 lhs, I64 rhs);
    I64 tester_op_fle(I64 lhs, I64 rhs);
    I64 tester_op_fgt(I64 lhs, I64 rhs);
    I64 tester_op_fge(I64 lhs, I64 rhs);
