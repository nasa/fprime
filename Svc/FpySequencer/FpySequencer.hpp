...
static_assert(static_cast<FwSizeType>(Svc::Fpy::MAX_STACK_SIZE) >= static_cast<FwSizeType>(FW_TLM_BUFFER_MAX_SIZE),
              "Max stack size must be greater than max tlm buffer size");
static_assert(static_cast<FwSizeType>(Svc::Fpy::MAX_STACK_SIZE) >= static_cast<FwSizeType>(FW_PARAM_BUFFER_MAX_SIZE),
