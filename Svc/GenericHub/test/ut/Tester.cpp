...
namespace Svc {
    ...
    connectPorts(void) 
  {
    ...
    for (NATIVE_INT_TYPE i = 0; i < 10; ++i) {
      this->connect_to_buffersIn(
              i,
              this->componentIn.get_buffersIn_InputPort(i)
      );
    }
    ...
    this->connect_to_dataIn(
        0,
        this->componentOut.get_dataIn_InputPort(0)
    );

    // buffersOut
    for (NATIVE_INT_TYPE i = 0; i < 10; ++i) {
      this->componentOut.set_buffersOut_OutputPort(
              i,
              this->get_from_buffersOut(i)
      );
    }

    // dataOut
    this->componentIn.set_dataOut_OutputPort(
        0,
    ...
    // ----------------------------------------------------------------------
    for (NATIVE_INT_TYPE i = 0; i < 10; ++i) {
      this->componentOut.set_portOut_OutputPort(
          i,
    ...
    for (NATIVE_INT_TYPE i = 0; i < 10; ++i) {
      this->connect_to_portIn(
          i,
          this->componentIn.get_portIn_InputPort(i)
      );
    }
  ...
  {
    this->init();
    this->componentIn.init(
        INSTANCE
    );
    this->componentOut.init(
        INSTANCE + 1
    );
  }
