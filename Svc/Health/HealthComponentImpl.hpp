...
class HealthImpl : public HealthComponentBase {
   public:
    ...
    void setPingEntries(PingEntry* pingEntries, NATIVE_INT_TYPE numPingEntries,
                        U32 watchDogCode);
    ...
    PRIVATE :
        ...
        //!  \param key Key value
        void
        PingReturn_handler(const NATIVE_INT_TYPE portNum, U32 key);
    ...
    void HLTH_ENABLE_cmdHandler(const FwOpcodeType opCode, U32 cmdSeq,
    ...
    //!  \param enable Enum for enabling/disabling tracker
    void HLTH_PING_ENABLE_cmdHandler(FwOpcodeType opCode, U32 cmdSeq,
    ...
    void HLTH_CHNG_PING_cmdHandler(const FwOpcodeType opCode, U32 cmdSeq,
                                   const Fw::CmdStringArg& entry,
                                   U32 warningValue, U32 fatalValue);

    //! Implementation for HLTH_PING command handler
    //! Ping specific component
    //!
    //!  \param opCode Command opcode
    //!  \param cmdSeq Command sequence
    //!  \param entry Ping entry number
    void HLTH_PING_cmdHandler(
        const FwOpcodeType opCode,    /*!< The opcode*/
        const U32 cmdSeq,             /*!< The command sequence number*/
        const Fw::CmdStringArg& entry /*!< The entry to ping*/
    );
