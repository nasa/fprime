...
def test_send_command(fprime_test_api):
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.getCmdDispName('Svc.ActiveLogger') + '.' + 'DUMP_FILTER_STATE', max_delay=1)
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.getCmdDispName('Svc.ActiveLogger') + '.' + 'SET_EVENT_FILTER', ["ACTIVITY_HI", "DISABLED"], max_delay=1)
    ...
    fprime_test_api.send_and_assert_command(fprime_test_api.getCmdDispName('Svc.ActiveLogger') + '.' + 'SET_EVENT_FILTER',["ACTIVITY_HI", "ENABLED"], max_delay=1)    
    fprime_test_api.send_and_assert_command(fprime_test_api.getCmdDispName('Svc.ActiveLogger') + '.' + 'SET_ID_FILTER', ["0x507", "DISABLED"], max_delay=1)
    fprime_test_api.send_and_assert_command(fprime_test_api.getCmdDispName('Svc.ActiveLogger') + '.' + 'DUMP_FILTER_STATE', max_delay=1)
