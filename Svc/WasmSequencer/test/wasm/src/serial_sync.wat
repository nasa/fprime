;; Invokes the synchronous serial port host function on port index 1 with a fixed
;; 8-byte pattern in guest memory.
;; serial_sync(index:i32, data_ptr:i32, data_size:i32) -> (void)
;; The reply port MUST NOT be connected: the host resumes the interpreter immediately.
