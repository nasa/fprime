...
| `ComLoggerFlushTimeout` | `ComLoggerDpCfg.hpp` | `U32` | `10` | Number of consecutive `schedIn` calls with no new Com buffer after which the partial container is sent (auto-flush) |
