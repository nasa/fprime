  ...
  python decode_comlogger_dp.py --input-file data_product.fdp --no-crc --no-sentry
    ...
    try:
        ...
        if args.dict_path:
            ...
            if dict_path.is_file() and dict_path.suffix == '.json':
                ...
                if json_files:
                    ...
                    print(f"Warning: No *Dictionary.json file found in {dict_path}")
        else:
        ...
        if is_directory and args.collect:
            # Collection mode - aggregate all DPs into GDS-style logs
            print("\n=== COLLECTION MODE ===")
