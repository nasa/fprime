...
elseif (NOT DEFINED FPRIME_PLATFORM_TYPES)
  message(FATAL_ERROR "\n[F-PRIME] FPRIME_PLATFORM_TYPES not set in '${CMAKE_SYSTEM_NAME}.cmake'.\n")
elseif (NOT EXISTS "${FPRIME_PLATFORM_TYPES}/PlatformTypes.cpp")
  message(FATAL_ERROR "\n[F-PRIME] '${FPRIME_PLATFORM_TYPES}/PlatformTypes.cpp' not found.")
elseif (NOT EXISTS "${FPRIME_PLATFORM_TYPES}/PlatformTypes.hpp")
  message(FATAL_ERROR "\n[F-PRIME] '${FPRIME_PLATFORM_TYPES}/PlatformTypes.hpp' not found.")
endif()
include_directories(SYSTEM "${FPRIME_PLATFORM_TYPES}")
