...
function(acwrap AC_TYPE AC_FINAL_SOURCE AC_FINAL_HEADER AI_XML)
  ...
  if (GENERATE_AC_IN_SOURCE)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E chdir ${CMAKE_CURRENT_SOURCE_DIR} ${CMAKE_COMMAND} -E remove ${CPP_NAME} ${AC_FINAL_SOURCE}
      COMMAND ${CMAKE_COMMAND} -E chdir ${CMAKE_CURRENT_SOURCE_DIR} ${CMAKE_COMMAND} -E remove ${HPP_NAME} ${AC_FINAL_HEADER}
      DEPENDS ${AC_FINAL_XML}
    )
  endif()
