...
function(install_add_deployment_target MODULE TARGET SOURCES DEPENDENCIES FULL_DEPENDENCIES)
    ...
    install(TARGETS ${MODULE} ${INSTALL_DEPENDENCIES}
            RUNTIME DESTINATION ${MODULE}/${TOOLCHAIN_NAME}/bin
            COMPONENT ${MODULE}
            LIBRARY DESTINATION ${MODULE}/${TOOLCHAIN_NAME}/lib
            COMPONENT ${MODULE}
            ARCHIVE DESTINATION ${MODULE}/${TOOLCHAIN_NAME}/lib/static
            COMPONENT ${MODULE}
    )
    install(FILES ${FPRIME_CURRENT_DICTIONARY_FILE} DESTINATION ${MODULE}/${TOOLCHAIN_NAME}/dict COMPONENT ${MODULE})
    add_custom_command(TARGET "${MODULE}" POST_BUILD COMMAND "${CMAKE_COMMAND}" -DCMAKE_INSTALL_COMPONENT=${MODULE} -P${CMAKE_BINARY_DIR}/cmake_install.cmake)
endfunction()
