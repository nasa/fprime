...
function(module_info_add_global_target CUSTOM_TARGET_NAME)
    ...
    add_custom_target("module_info"
        COMMAND "${FPRIME__INTERNAL_PROPERTY_WRITER}" "--file" "${MODULE_INFO_FILE}.part"
            ...
            "$<TARGET_PROPERTY:${FPRIME_GLOBAL_INTERFACE_TARGET},FPRIME_CHOSEN_IMPLEMENTATIONS>" 
        COMMAND_EXPAND_LISTS
        COMMAND "${FPRIME__INTERNAL_PROPERTY_WRITER}" "--file" "${MODULE_INFO_FILE}.part" "--append"
            SET TARGET ${FPRIME_GLOBAL_INTERFACE_TARGET} PROPERTY FPRIME_SUB_BUILD_LOCATIONS
            "$<TARGET_PROPERTY:${FPRIME_GLOBAL_INTERFACE_TARGET},FPRIME_LOCATIONS>" 
        COMMAND_EXPAND_LISTS
