...
macro(fprime_initialize_build_system)
    ...
    if (NOT _FPRIME_BUILD_SYSTEM_LOADED)
        ...
        if (NOT FPRIME_IS_SUB_BUILD)
            ...
            get_property(FPRIME_SUBBUILD_LOCATIONS TARGET ${FPRIME_GLOBAL_INTERFACE_TARGET} PROPERTY FPRIME_SUBBUILD_LOCATIONS)
            fprime_cmake_status("[FPRIME] Module locations: ${FPRIME_SUBBUILD_LOCATIONS}")
