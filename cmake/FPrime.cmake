...
function(fprime_detect_libraries)
    foreach (LIBRARY_DIR IN LISTS FPRIME_LIBRARY_LOCATIONS)
        ...
        elseif (EXISTS "${LIBRARY_DIR}/${LIBRARY_NAME}.cmake")
            ...
            message(WARNING "[LIBRARY] ${LIBRARY_DIR} does not define library.cmake nor ${LIB_NAME}.cmake. Skipping.")
            continue()
        endif()
        message(STATUS "[LIBRARY] Including library ${LIB_NAME} at ${LIBRARY_DIR}")
        if (CMAKE_DEBUG_OUTPUT)
            message(STATUS "[LIBRARY] ${LIB_NAME} using manifest ${MANIFEST_FILE}")
        endif()
...
function(fprime_setup_included_code)
    ...
    foreach (LIBRARY_MANIFEST IN LISTS FPRIME_LIBRARY_MANIFESTS)
        ...
        if (FPRIME_ENABLE_${LIB_NAME}_UTS)
            set(__FPRIME_NO_UT_GEN__ ON)
        endif()
