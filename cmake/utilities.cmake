...
function(generate_individual_function_call OUTPUT_FILE FUNCTION ARG_COUNT)
    # Build an invocation string of the form: ${FUNCTION}("${ARG2}" "${ARG3}" ..."${ARG_COUNT -1 + 2}")
    ...
    #     3. Arg numbers start at 2. This accounts for ARG0==CALL and ARG1==Function name in the calling function
    set(ARG_STRING "")
    math(EXPR BOUND "${ARG_COUNT} - 1")
    foreach(ARG_IT RANGE "${BOUND}")
        math(EXPR ARG_NUM "${ARG_IT} + 2")
        set(ARG_STRING "${ARG_STRING} \"\${ARG${ARG_NUM}}\"")
    endforeach()
...
function(generate_faux_cmake_language)
    ...
    file(APPEND "${FAUX_FILE}" "function(cmake_language ACTION FUNCTION_NAME)\n")
    ...
    foreach(FUNCTION IN LISTS FUNCTIONS)
        if (CMAKE_DEBUG_OUTPUT)
            ...
            message(STATUS "Mimicking cmake_language(CALL ${FUNCTION} \"\${ARG2}\" ... \"\${ARG${ARG_TOP}}\"")
        endif()
    ...
    file(APPEND "${FAUX_FILE}" "endfunction(cmake_language)\n")
    include("${FAUX_FILE}")
endfunction()
