...
function(fprime_util_metadata_clear CHILD_DIRECTORY)
    file(REMOVE "${CHILD_DIRECTORY}/${FPRIME__INTERNAL_UTILITY_MODULE_FILE}")
    file(REMOVE "${CHILD_DIRECTORY}/${FPRIME__INTERNAL_UTILITY_SUBDIRECTORY_FILE}")
    file(REMOVE "${CHILD_DIRECTORY}/${FPRIME__INTERNAL_UTILITY_TESTS_FILE}")
endfunction()
