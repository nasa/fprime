...
function(sub_add_global_target TARGET)
    add_custom_target("${TARGET}" COMMAND ${CMAKE_COMMAND} -E touch "${CMAKE_BINARY_DIR}/sub-test")
    add_custom_target("${TARGET}" COMMAND ${CMAKE_COMMAND} -E touch "${FPRIME_BINARY_DIR}/sub-test")
