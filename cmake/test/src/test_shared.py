...
EXPECTED = [
    ...
    os.path.join("lib", platform.system(), "libSvc_PassiveTextLogger." + ext),
    os.path.join("lib", platform.system(), "libSvc_FileManager." + ext),
    os.path.join("lib", platform.system(), "libSvc_PolyDb." + ext),
    os.path.join("lib", platform.system(), "libSvc_SocketGndIf." + ext),
    ...
    os.path.join("lib", platform.system(), "libSvc_GndIf." + ext),
    ...
    os.path.join("lib", platform.system(), "libSvc_BuffGndSockIf." + ext),
