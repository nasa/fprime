...
OPTIONS = {"CMAKE_INSTALL_PREFIX": tmp_dir}
EXPECTED = [
    os.path.join(tmp_dir, "bin", platform.system(), "Ref"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libDrv_BlockDriver.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_FileUplink.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_CmdSequencer.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libFw_Time.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_PassiveTextLogger.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_FileManager.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_PolyDb.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_SocketGndIf.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libRef_SendBuffApp.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libFw_FilePacket.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_Ping.a"),
    ...
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libRef_PingReceiver.a"),
    ...
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libFw_Log.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libFw_Tlm.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libOs.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libRef_SignalGen.a"),
    ...
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libRef_RecvBuffApp.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_Time.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_GndIf.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libFw_Cfg.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_Fatal.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_ActiveLogger.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_BufferManager.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libFw_Cmd.a"),
    os.path.join(tmp_dir, "lib", "static", platform.system(), "libSvc_BuffGndSockIf.a"),
