...
EXPECTED = [
    os.path.join(BUILD_DIR, "bin", platform.system(), "Ref"),
    ...
    os.path.join(BUILD_DIR, "lib", "static", platform.system(), "libSvc_PassiveTextLogger.a"),
    ...
    os.path.join(BUILD_DIR, "lib", "static", platform.system(), "libSvc_SocketGndIf.a"),
    ...
    os.path.join(BUILD_DIR, "lib", "static", platform.system(), "libRef_SignalGen.a"),
    ...
    os.path.join(BUILD_DIR, "lib", "static", platform.system(), "libSvc_GndIf.a"),
    ...
    os.path.join(BUILD_DIR, "lib", "static", platform.system(), "libSvc_BuffGndSockIf.a"),
