...
def run_parallel_depend(fpp_depend, fpp_locs, file_input):
    ...
    for line in lines:
        ...
        full_list = [fpp_depend, fpp_locs] + arguments + ["-d", "direct.txt", "-m", "missing.txt", "-f", "framework.txt", "-g", "generated.txt", "-i", "include.txt"]
...
def main():
    try:
        ...
        print("[ERROR] Bad arguments: fpp-depend path, locs file path, file input and integer PARALLEL_JOBS env var.")
