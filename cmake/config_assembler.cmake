...
function(fprime__internal_flush_configuration)
    ...
    list(LENGTH RECORDED_DESTINATIONS DESTINATION_COUNT)
    if (DESTINATION_COUNT EQUAL 0)
        return()
    endif()
    math(EXPR LAST_INDEX "${DESTINATION_COUNT} - 1")
    foreach(DESTINATION_INDEX RANGE ${LAST_INDEX})
        list(GET RECORDED_DESTINATIONS ${DESTINATION_INDEX} DESTINATION)
        list(GET RECORDED_SOURCES ${DESTINATION_INDEX} SOURCE)
