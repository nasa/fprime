...
#define CMD_TEST_DECL(TYPE, ASYNC) \
    void test##ASYNC##Command(NATIVE_INT_TYPE portNum, FppTest::Types::TYPE& data);
...
\
    this->invoke_to_cmdOut( \
        portNum, \
        component.OPCODE_CMD_ASYNC_NO_ARGS, \
        1, \
        buf \
    ); \
...
\
    this->invoke_to_cmdOut( \
        portNum, \
        component.OPCODE_CMD_ASYNC_PRIMITIVE, \
        1, \
        buf \
    ); \
    status = this->doDispatch(); \
...
\
    this->invoke_to_cmdOut( \
        portNum, \
        component.OPCODE_CMD_ASYNC_STRINGS, \
        1, \
        buf \
    ); \
    status = this->doDispatch(); \
...
\
    this->invoke_to_cmdOut( \
        portNum, \
        component.OPCODE_CMD_ASYNC_ENUM, \
        1, \
        buf \
    ); \
    status = this->doDispatch(); \
...
\
    this->invoke_to_cmdOut( \
        portNum, \
        component.OPCODE_CMD_ASYNC_ARRAY, \
        1, \
        buf \
    ); \
    status = this->doDispatch(); \
...
\
    this->invoke_to_cmdOut( \
        portNum, \
        component.OPCODE_CMD_ASYNC_STRUCT, \
        1, \
        buf \
    ); \
    status = this->doDispatch(); \
