...
module ComCfg {
    ...
    struct FrameContext {
        ...
        saIndex: U16                @< Security Association Index - recorded by SDLS deframers (uplink) and framers (downlink); informational only, framers encrypt with their configured SA_INDEX
    } default {
        comQueueIndex = 0
