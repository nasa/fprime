...
CountingSemaphoreInterface* CountingSemaphoreInterface::getDelegate(
    ...
    U32 initial_count) {
    static_assert(std::is_base_of<CountingSemaphoreInterface, Os::Stub::CountingSemaphore::Test::TestCountingSemaphore>::value,
                  "Implementation must derive from CountingSemaphoreInterface");
    static_assert(sizeof(Os::Stub::CountingSemaphore::Test::TestCountingSemaphore) <= sizeof(CountingSemaphoreHandleStorage),
    ...
    auto* ptr = new (aligned_placement_new_memory) Os::Stub::CountingSemaphore::Test::TestCountingSemaphore(initial_count);
