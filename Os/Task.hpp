...
namespace Os {
    ...
    class Task {
        public:
            ...
            DEPRECATED(TaskStatus start(const Fw::StringBase &name, NATIVE_UINT_TYPE identifier, NATIVE_UINT_TYPE priority, NATIVE_UINT_TYPE stackSize, taskRoutine routine, void* arg, NATIVE_UINT_TYPE cpuAffinity = TASK_DEFAULT),
