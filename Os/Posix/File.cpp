...
mode_t PosixFile::map_open_create_mode(const U32 create_mode) {
    ...
    FW_ASSERT(
        (create_mode & ~(Os::FILE_MODE_IRUSR | Os::FILE_MODE_IWUSR | Os::FILE_MODE_IXUSR | Os::FILE_MODE_IRGRP |
                         Os::FILE_MODE_IWGRP | Os::FILE_MODE_IXGRP | Os::FILE_MODE_IROTH | Os::FILE_MODE_IWOTH |
                         Os::FILE_MODE_IXOTH | Os::FILE_MODE_ISUID | Os::FILE_MODE_ISGID | Os::FILE_MODE_ISVTX)) == 0,
