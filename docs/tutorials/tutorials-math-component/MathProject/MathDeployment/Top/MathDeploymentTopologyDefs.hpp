...
#include "MathProject/MathDeployment/Top/FppConstantsAc.hpp"
 ...
 */
namespace PingEntries {
    namespace MathProject_rateGroup1 {enum { WARN = 3, FATAL = 5 };}
    namespace MathProject_rateGroup2 {enum { WARN = 3, FATAL = 5 };}
    namespace MathProject_rateGroup3 {enum { WARN = 3, FATAL = 5 };}
    namespace MathProject_cmdSeq {enum { WARN = 3, FATAL = 5 };}
}  // namespace PingEntries
 ...
 *
 * The topology autocoder requires an object that carries state with the name `MathProject::TopologyState`. Only the type
