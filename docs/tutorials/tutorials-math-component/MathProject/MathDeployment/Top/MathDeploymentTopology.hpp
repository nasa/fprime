...
#include <MathProject/MathDeployment/Top/MathDeploymentTopologyDefs.hpp>
 ...
 *
 * For an explanation of the required type MathProject::TopologyState see: MathProjectTopologyDefs.hpp.
 *
