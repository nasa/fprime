...
This guide uses the [DataProduct/Producer](https://github.com/nasa/fprime-examples/tree/devel/DataProduct/Producer) example from `fprime-examples` as a concrete example.
