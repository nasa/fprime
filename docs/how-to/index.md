...
-   <span class="card-title">__F´ GDS Plugin Development__</span>
    ...
    [View Develop F´ GDS Plugins](gds-and-operations/develop-gds-plugins.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__F´ Library Development__</span>
    ...
    [View Develop F´ Libraries](develop-your-project/develop-fprime-libraries.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Integrating Third-Party Libraries__</span>
    ...
    [View Integrating Third-Party Libraries](integrate-libraries-and-platforms/integrate-external-libraries.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Porting F´ To a New Platform__</span>
    ...
    [View Porting Guide](integrate-libraries-and-platforms/implement-osal.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Implement a Framing Protocol__</span>
    ...
    [View Implement a Framing Protocol](integrate-libraries-and-platforms/custom-framing.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Generate Data Products__</span>
    ...
    [View Generate Data Products](develop-your-project/data-products.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Define State Machines__</span>
    ...
    [View Define State Machines](develop-your-project/define-state-machines.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Create Ground-Derived Channels__</span>
    ...
    [View Create Ground-Derived Channels](gds-and-operations/derive-channels-on-ground.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Develop a Device Driver__</span>
    ...
    [View Develop a Device Driver](develop-your-project/develop-device-driver.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Develop a Subtopology__</span>
    ...
    [View Develop a Subtopology](develop-your-project/develop-subtopologies.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Implement an OS Abstraction Layer__</span>
    ...
    [View Implement an OS Abstraction Layer](integrate-libraries-and-platforms/implement-osal.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Implement a Radio Manager Component__</span>
    ...
    [View Implement a Radio Manager Component](develop-your-project/implement-radio-manager.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Develop Components in Python__</span>
    ...
    [View Develop Components in Python](develop-your-project/python-development.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Write Rule-Based Tests__</span>
    ...
    [View Write Rule-Based Tests](test-your-project/rule-based-testing.md){ .md-button .md-button--primary }
...
-   <span class="card-title">__Test-Driven Development__</span>
    ...
    [View Test-Driven Development](test-your-project/test-driven-development.md){ .md-button .md-button--primary }
