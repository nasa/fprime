...
|-------------------------|-----------------------------|-----------------------------|--------|-----------------|
| PlatformIndexType       | Ports indices               | PRI_PlatformIndexType       | Yes    | Minimum 1 Byte  |
...
|------------------|----------------------|------------------------|----------------------|--------|-----------------|
| FwIndexType      | Port indices         | PlatformIndexType      | PRI_FwIndexType      | Yes    | Minimum 1 Byte  |
