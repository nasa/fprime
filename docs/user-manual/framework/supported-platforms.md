...
| ---------------- | -------------------- | ------------------------------- | ---------------------------------- | ------------ |
| Apple Silicon    | Darwin    | ARM  | [`F Prime Ref`](https://github.com/nasa/fprime) | [![CI](https://github.com/nasa/fprime/actions/workflows/framework.yml/badge.svg)](https://github.com/nasa/fprime/actions/workflows/framework.yml) |
...
| Pi Pico 2        | Zephyr    | RISC-V | [`fprime-zephyr-reference`](https://github.com/fprime-community/fprime-zephyr-reference) | [![External Repo: Zephyr Reference (Pico 2)](https://github.com/nasa/fprime/actions/workflows/ext-fprime-zephyr-reference.yml/badge.svg)](https://github.com/nasa/fprime/actions/workflows/ext-fprime-zephyr-reference.yml) |
...
| Teensy41         | Zephyr    | ARMv7-M | [`fprime-zephyr-reference`](https://github.com/fprime-community/fprime-zephyr-reference) | [![External Repo: Zephyr Reference (Teensy 4.1)](https://github.com/nasa/fprime/actions/workflows/ext-fprime-zephyr-reference.yml/badge.svg)](https://github.com/nasa/fprime/actions/workflows/ext-fprime-zephyr-reference.yml) |
| x86              | Linux     | x86\_64 | [`F Prime Ref`](https://github.com/nasa/fprime) | [![CI](https://github.com/nasa/fprime/actions/workflows/framework.yml/badge.svg)](https://github.com/nasa/fprime/actions/workflows/framework.yml) [![CI [RHEL8]](https://github.com/nasa/fprime/actions/workflows/build-test-rhel8.yml/badge.svg)](https://github.com/nasa/fprime/actions/workflows/build-test-rhel8.yml) |
