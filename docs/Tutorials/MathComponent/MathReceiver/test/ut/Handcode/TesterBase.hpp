...
namespace Ref {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      //!
      History<EventEntry_MR_SET_FACTOR1> 
    ...
    protected:
      ...
      //!
      History<EventEntry_MR_UPDATED_FACTOR2> 
    ...
    protected:
      ...
      //!
      History<EventEntry_MR_OPERATION_PERFORMED> 
