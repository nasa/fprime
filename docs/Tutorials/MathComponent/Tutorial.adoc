...
section to add three more tests, one test each
...
When doing math, this component performs the requested
operation and then multiplies by this factor.
For example, if the arguments of the `mathOpIn` port
are stem:[v_1], `ADD`, and stem:[v_2], and the factor is stem:[f],
