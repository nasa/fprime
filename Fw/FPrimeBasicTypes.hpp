...
static_assert(static_cast<FwSizeType>(FW_FIXED_LENGTH_STRING_SIZE) >= FW_CMD_STRING_MAX_SIZE,
              "A generic string should be able to hold a command string");
static_assert(static_cast<FwSizeType>(FW_FIXED_LENGTH_STRING_SIZE) >= FW_LOG_STRING_MAX_SIZE,
              "A generic string should be able to hold an event string");
static_assert(static_cast<FwSizeType>(FW_FIXED_LENGTH_STRING_SIZE) >= FW_TLM_STRING_MAX_SIZE,
              "A generic string should be able to hold a telemetry string");
static_assert(static_cast<FwSizeType>(FW_FIXED_LENGTH_STRING_SIZE) >= FW_PARAM_STRING_MAX_SIZE,
