...
static_assert(std::numeric_limits<PlatformSignedSizeType>::min() <= std::numeric_limits<int>::min(),
                "PlatformSignedSizeType must be at small as large as int");
static_assert(std::numeric_limits<PlatformIndexType>::is_signed, "PlatformIndexType must be signed");
static_assert(not std::numeric_limits<PlatformSizeType>::is_signed, "PlatformSizeType must be signed");
...
static_assert(not std::numeric_limits<FwSizeType>::is_signed, "FwSizeType must be signed");
