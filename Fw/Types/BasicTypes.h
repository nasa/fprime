...
#define PRI_I8 PRIi8  // NO_CODESONAR macro delim

typedef uint8_t U8;   //!< 8-bit unsigned integer
#define PRI_U8 PRIu8  // NO_CODESONAR macro delim

typedef U8 BYTE;        //!< byte type
#define PRI_BYTE PRIu8  // NO_CODESONAR macro delim

typedef char CHAR;
#define PRI_CHAR "c"  // NO_CODESONAR macro delim

#if FW_HAS_16_BIT
typedef int16_t I16;    //!< 16-bit signed integer
#define PRI_I16 PRIi16  // NO_CODESONAR macro delim
typedef uint16_t U16;   //!< 16-bit unsigned integer
#define PRI_U16 PRIu16  // NO_CODESONAR macro delim
#endif

#if FW_HAS_32_BIT
typedef int32_t I32;    //!< 32-bit signed integer
#define PRI_I32 PRIi32  // NO_CODESONAR macro delim
typedef uint32_t U32;   //!< 32-bit unsigned integer
#define PRI_U32 PRIu32  // NO_CODESONAR macro delim
#endif

#if FW_HAS_64_BIT
typedef int64_t I64;    //!< 64-bit signed integer
#define PRI_I64 PRIi64  // NO_CODESONAR macro delim
typedef uint64_t U64;   //!< 64-bit unsigned integer
#define PRI_U64 PRIu64  // NO_CODESONAR macro delim
#endif

typedef float F32;    //!< 32-bit floating point
#define PRI_F64 "lf"  // NO_CODESONAR macro delim
