...
typedef enum {
    ...
    FW_SERIALIZE_UNIMPLEMENTED,    //!< Serialize has not be implemented for this type
    FW_DESERIALIZE_UNIMPLEMENTED,  //!< Deserialize has not be implemented for this type
} SerializeStatus;
