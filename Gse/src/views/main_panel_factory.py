...
class MainPanelFactory:
    ...
    def create(self, root, top=True):
        ...
        stat_bar_updater.observers_add(stat_bar)
        ...
        ev_listen.observers_add(logger_panel)
        if top == True:
        ...
        #
        if top == True:
            ev_listen.setupBinaryLogging(self.__opts)
        ...
        ch_listen.observers_add(telm_panel)
        #
        if top == True:
            ev_listen.register_root(root)
            ev_listen.register_main_panel(the_panel)
            id = root.after(time_period, ev_listen.update_task)
            ev_listen.set_after_id(id)
        ...
        the_updater.observers_add(stat_panel)
        if top:
        ...
        f_listener.observers_add(f_panel)
        if top:
        ...
        sc_listener.observers_add(strip_panel)
