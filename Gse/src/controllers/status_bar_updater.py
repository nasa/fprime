...
class StatusBarUpdater(observer.Observed):
    """
    ...
    def update_data(self, num_recv, num_sent, data_incoming=True):
        self.__num_recv   += num_recv
        self.__num_sent   += num_sent
        self.__data_incoming = data_incoming
