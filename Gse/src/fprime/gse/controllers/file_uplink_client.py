...
from fprime.gse.models.serialize.filepacket import *
from fprime.gse.utils.checksum import Checksum
...
class UplinkShell(object):
    ...
    def spawn(self, host, port, src_path, dest_path):
        ...
        uplink_path = self.__build_root +os.sep+ 'Gse' + os.sep + 'src' + os.sep + 'fprime' + os.sep + 'gse' + os.sep + 'controllers' + os.sep + 'file_uplink_client.py'
