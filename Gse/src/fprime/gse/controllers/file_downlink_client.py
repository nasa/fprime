...
from fprime.gse.utils.checksum import *
from fprime.gse.utils import Logger

from fprime.gse.models.serialize.filepacket import PacketType
from fprime.gse.models.serialize import filepacket
...
class DownlinkShell(object):
	...
	def spawn(self, host, port):
		...
		downlink_path = self.__build_root +os.sep+ 'Gse' + os.sep + 'src' + os.sep + 'fprime' + os.sep + 'gse' + os.sep + 'controllers' + os.sep + 'file_downlink_client.py'
