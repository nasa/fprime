...
The `Drv/TickInterface` is an interface for outputting a system tick along with a RawTime timestamp. The [`Ref::BlockDriver`](../../../Ref/BlockDriver/BlockDriver.fpp) driver is an example of a notional driver that implements this interface.
