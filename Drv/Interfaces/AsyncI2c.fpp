module Drv {
    interface AsyncI2c {
        ...
        async input port write: [Drv.AsyncI2cCfg.I2cDriverPorts] Drv.I2cRequest

        @ Port for asynchronous read transaction
        async input port read: [Drv.AsyncI2cCfg.I2cDriverPorts] Drv.I2cRequest

        @ Port for asynchronous write-read transaction
        async input port writeRead: [Drv.AsyncI2cCfg.I2cDriverPorts] Drv.I2cWriteReadRequest
