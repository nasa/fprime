// ======================================================================
// \title  LinuxGpioDriverV2.hpp
// \brief  hpp file for LinuxGpioDriverV2 component implementation class
//
// \copyright
...
#ifndef DRV_LINUX_GPIO_DRIVER_V2_HPP
#define DRV_LINUX_GPIO_DRIVER_V2_HPP

#include <Os/File.hpp>
#include <Os/Mutex.hpp>
#include <Os/Task.hpp>
#include "Drv/LinuxGpioDriverV2/LinuxGpioDriverV2ComponentAc.hpp"

namespace Drv {

//! \brief GPIO driver using version 2 of the Linux GPIO character device uAPI
//!
//! This component implements the Drv.Gpio interface using the version 2 (gpio_v2_*)
//! ioctl interface of the Linux GPIO character device. Version 2 supersedes the
//! deprecated version 1 (gpiohandle_*/gpioevent_*) interface used by LinuxGpioDriver.
class LinuxGpioDriverV2 final : public LinuxGpioDriverV2ComponentBase {
  public:
    ...
    //! Construct object LinuxGpioDriverV2
    //!
    LinuxGpioDriverV2(const char* const compName /*!< The component name*/
    );

    //! Destroy object LinuxGpioDriverV2
    //!
    ~LinuxGpioDriverV2();
  ...
  private:
    //! \brief helper to request a line using the v2 uAPI
    Os::File::Status setupLineRequest(const int chip_descriptor,
                                      const U32 gpio,
                                      const GpioConfiguration& configuration,
...
#endif  // DRV_LINUX_GPIO_DRIVER_V2_HPP
